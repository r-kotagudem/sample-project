<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<a data-toggle="modal" data-target="#loginModal" id="login" href="#" style="padding-top: 25px;">
			<img border="0" alt="W3Schools" src="style/login.png" width="30" height="30" >
		</a>
		...
		<div id="welcome">
			<li class="nav-item dropdown no-arrow"><a
				...
				aria-expanded="false"> <span
					class="mr-2 d-none d-lg-inline text-gray-600 small">${email}</span>
